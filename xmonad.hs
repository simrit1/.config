...
myStartupHook = do
    ...
    spawnOnce "nm-applet &"
    spawnOnce "trayer --edge top --align right --widthtype request --padding 1 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --tint 0x282c34  --height 22 &"
    ...
    setWMName "XMonad"
    --execScriptHook "zsh && killall nm-applet volumeicon blueman-applet pamac-tray"
...
myWorkspaces = [" dev ", " www ", " sys ", " mus ", " vbox ", " zoom ", " doc ", " vid ", " gfx "]
...
main = do
    ...
    xmproc <- spawnPipe "xmobar -x 0 /home/sachin/.config/xmobar/xmobarrc"
